...
import com.example.echopaw.databinding.FragmentPhonograph2Binding
import com.example.echopaw.utils.ToastUtils

/**
 * 留声机日历页面Fragment
 * 
 * 该Fragment提供日历相关功能，包括：
 * 1. 取消按钮 - 返回上一页
 * 2. 确认按钮 - 跳转到录音页面
 * 3. 返回按钮功能
 */
class PhonographFragment2 : Fragment() {
    
    /**
     * ViewBinding实例，可为空
     * 使用私有可变属性确保在Fragment销毁时正确清理
     */
    private var _binding: FragmentPhonograph2Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPhonograph2Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 设置确认按钮点击事件 - 跳转到PhonographFragment3
    ...
    private fun navigateToFragment(fragment: Fragment) {
        try {
            ...
            android.util.Log.e("PhonographFragment2", "Error navigating to fragment", e)
    ...
    private fun navigateBack() {
        try {
            ...
            android.util.Log.e("PhonographFragment2", "Error in navigateBack", e)
            activity?.finish()
        }
    }
